...
const backgroundImage = "https://cloudworks-bukkit.s3.eu-west-2.amazonaws.com/nwbuddy/loadingimages/loadingimage5_07_05_2022.png";
...
class Section extends React.Component {
    render() {
        ...
        return (
            <div className={classes.toString() + "flex flex-col w-[100%] h-[100%] bg-[#333] p-0" + ` ${this.props.bg ? this.props.bg : ""}` + ` ${this.props.depth ? this.props.depth : "z-10"} w-full h-full`} style={{ backgroundImage: this.props.bgSrc ? "url(" + this.props.bgSrc + ")" : null, backgroundPosition: "center", backgroundSize: "102vw 102vh" }}>
                {this.props.children}
            </div>
        );
    }
